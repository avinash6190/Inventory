    ...
    <form id="form1" runat="server">
        <script>
            ...
            function Opendownload1(RowIndex) {
                ...
                window.location.href = 'Mgment/FileDownload.ashx?RowIndex=' + rowIndex + "&fileURL=''";
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Title">
                                                        <ItemTemplate>
                                                            ...
                                                            <a href="Mgment/FileDownload.ashx?RowIndex=<%# Container.DisplayIndex %>&fileURL=<%#Eval("FileURL") %>" target="_blank"><%#Eval("Title")%> </a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

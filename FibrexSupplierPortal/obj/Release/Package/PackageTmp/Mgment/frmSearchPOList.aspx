                    ...
                    <div class="table-responsive" style="overflow: auto;">
                        <dx:ASPxGridView ID="gvSearchPurchaseOrder" runat="server" AutoGenerateColumns="False" Width="100%" EnableCallBacks="False" OnPageIndexChanged="gvSearchTemplates_PageIndexChanged" KeyFieldName="PONUM" OnHtmlDataCellPrepared="gvSearchPurchaseOrder_HtmlCommandCellPrepared" OnBeforeColumnSortingGrouping="gvSearchPurchaseOrder_BeforeColumnSortingGrouping">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="MR Number" FieldName="MRNUM" VisibleIndex="12" Visible="false">
                                    <PropertiesTextEdit DisplayFormatString=""></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Payment And Terms" FieldName="PAYMENTTERMS" VisibleIndex="13" Visible="false">
                                    <PropertiesTextEdit DisplayFormatString=""></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Order Date" FieldName="ORDERDATE" VisibleIndex="14" Visible="false">
                                    <PropertiesTextEdit DisplayFormatString=""></PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                            </Columns>

...
<ul class="nav" id="side-menu">
    <li  id="menuSearchSupplier" runat="server"  visible="true">
        <a href="frmDashboard"><i class="fa fa-table fa-fw"></i>Supplier Management Dashboard</a>
    </li>
    <li   id="menuSearchPurchaseOrder" runat="server"  visible="true">
        <a href="frmPurchaseOrderDashboard"><i class="fa fa-table fa-fw"></i>Purchase Order Dashboard</a>
    </li>    
</ul>
<%-- </div>
</div>--%> 
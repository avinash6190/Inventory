...
namespace FibrexSupplierPortal.Mgment
{
    ...
    public class FileDownload : IHttpHandler, IReadOnlySessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
                ...
                string reqFileURl = context.Request.QueryString["fileURL"].ToString();
                if (context.Request.QueryString["RowIndex"] != null)
                {
                    ...
                    FileURl = reqFileURl != string.Empty ? context.Request.QueryString["fileURL"].ToString(): dt.Rows[RowIndex]["FileURL"].ToString();

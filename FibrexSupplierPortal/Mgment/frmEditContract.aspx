<%@ Page Title="" Language="C#" MasterPageFile="~/Mgment/mainMaster.Master" AutoEventWireup="true" CodeBehind="frmEditContract.aspx.cs" Inherits="FibrexSupplierPortal.Mgment.frmEditContract" EnableEventValidation="true" %>
...
<%@ Register Src="~/Mgment/Control/ContractStatusHistory.ascx" TagPrefix="uc1" TagName="ContractStatusHistory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
           ...
           <%-- $('#<%=txtPaymentTerms.ClientID%>').maxlength({
                events: [], // Array of events to be triggered
                maxCharacters: 250
            });--%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="RPTheadingName">
            <asp:Label ID="lblGeneralSupplierName" runat="server" Text="Update Contract Summary Sheet"></asp:Label>
                ...
                <div class="tab-pane fade in active" id="poContracts">
                    ...
                    <asp:UpdatePanel ID="UpPODetail" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                                            ...
                                            <fieldset>
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                        Contract ID</label>
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="lblContractID" runat="server" CssClass="form-control" ValidationGroup="Equip" Enabled="false"></asp:TextBox>
                                                    </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                    Status</label>
                                                <div class="col-sm-7">
                                                    <asp:TextBox ID="txtStatus" runat="server" CssClass="form-control" Text="" Enabled="false" ValidationGroup="Equip"></asp:TextBox>
                                                </div>
                                                <div style="width: 2%; float: left;">
                                                </div>
                                            </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                    <span class="showAstrik">*</span>Total Cost<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="" ControlToValidate="txtTotalAmount" InitialValue="0.00" CssClass="ValidationError" ValidationGroup="Equip"></asp:RequiredFieldValidator>
                                                </label>
                                                <div class="col-sm-7">
                                                    <asp:TextBox ID="txtTotalAmount" runat="server" CssClass="form-control" onkeyup="javascript:this.value=Comma(this.value);" ValidationGroup="Equip"></asp:TextBox>
                                                </div>
                                                <div style="margin-left: -17px; float: left;" class="col-sm-1">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="txtCompanyID" runat="server" OnTextChanged="txtCompanyID_TextChanged" AutoPostBack="true" CssClass="form-control" ValidationGroup="Equip"></asp:TextBox>
                            ...
                            <asp:Panel ID="PanelShowError" runat="server" class="ResetPanel2" Style="display: none; width: 40% !important;">
                                <div style="width: 25px; height: 25px; position: absolute; margin-left: 96%; margin-top: 7px; cursor: pointer;">
                            ...
                            <div class="reg-panel panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal">
                                        ...
                                        <asp:Button ID="btnSelectContractID" runat="server" OnClick="btnSelectContractID_Click" Style="display: none; width: 80%;" />
                                        ...
                                        <asp:Panel ID="pnlContractList" runat="server" class="ResetPanel" Style="display: none; width: 80% !important;">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="control-label col-sm-7 Pdringtop txtleft" for="inputName">
                                                            <asp:Label ID="lblContractCreatedBy" runat="server"></asp:Label>
                                                        </label>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-4 Pdringtop" for="inputName">
                                                        ...
                                                        <label class="control-label col-sm-7 Pdringtop txtleft" for="inputName">
                                                            <asp:Label ID="lblContractModifiedBy" runat="server"></asp:Label>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="control-label col-sm-7 Pdringtop txtleft" for="inputName">
                                                            <asp:Label ID="lblContractCreationTimestamp" runat="server"></asp:Label>
                                                        </label>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-4 Pdringtop" for="inputName">
                                                        ...
                                                        <label class="control-label col-sm-7 Pdringtop txtleft" for="inputName">
                                                            <asp:Label ID="lblContractLastModifyTIme" runat="server"></asp:Label>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <asp:Panel ID="pnlpopup" runat="server" class="ResetPanel" Style="display: none;">
                                ...
                                <asp:UpdatePanel ID="upChangeStatus" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div class="modal-body">
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <asp:Label ID="lblPopupContractNumber" runat="server" CssClass="form-control"></asp:Label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <asp:Label ID="lblpopupContractStatus" runat="server" CssClass="form-control"></asp:Label>
                                                        <asp:HiddenField ID="HidPopUPContractOldStatus" runat="server" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                                        <span class="showAstrik">*</span><asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ErrorMessage="*" ControlToValidate="ddlContractStatus" InitialValue="Select" CssClass="ValidationError" ValidationGroup="Popup"></asp:RequiredFieldValidator>
                                                        New Status
                                                    </label>
                                                    <div class="col-sm-7">
                                                        <asp:DropDownList ID="ddlContractStatus" runat="server" CssClass="form-control" DataValueField="Value" DataTextField="Description" ValidationGroup="Popup"></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                        ...
                                        <div class="modal-footer">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="button" class="btn btn-secondary" onclick="return HideContractPop();">Close</button>
                                ...
                                <div class="modal-dialog" role="document" style="width: 830px;">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalhisotryLabel1">View Status History</h4>
                                        </div>
                                        <div class="modal-body">
                                            <uc1:ContractStatusHistory runat="server" ID="ContractStatusHistory" />
                                        </div>
                                        <div class="modal-footer">
                                            <div class="col-sm-offset-2 col-sm-10">

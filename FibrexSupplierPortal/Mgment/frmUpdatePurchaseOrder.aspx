...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowSOD() {
            if (document.getElementById('<%=chkInternatinal.ClientID%>').checked) {
                popupIncoterms.Show();
            }
            else {
                popupSOD.Show();
        ...
        function OnSelectCloseSODpopup(s, e) {
            isDirtyselectSOD = true;
            popupSOD.Hide();
        }
        
        function OnSelectCloseIncotermsPopup(s, e) {
            isDirtyselectIncoterms = true;
            popupIncoterms.Hide();
        }
    ...
    <div>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="POHome">
                        ...
                        <div class="reg-panel panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <dx:ASPxPopupControl ID="popupContract" runat="server" CloseAction="CloseButton" CloseOnEscape="true" Modal="True" ClientInstanceName="popupContract"
                                 ...
                                 <%--SOD--%>
                                <%-- <dx:ASPxPopupControl ID="popupSOD" runat="server" CloseAction="CloseButton" CloseOnEscape="true" Modal="True" ClientInstanceName="popupSOD"
                                    PopupHorizontalAlign="WindowCenter" AllowDragging="true" PopupVerticalAlign="WindowCenter" HeaderText="List of Scope Of Delivery" Width="450px" PopupAnimationType="None" EnableViewState="False">
                                    <ContentCollection>
                                        <dx:PopupControlContentControl runat="server">
                                            <p>Select Scope of Delivery</p>
                                            <br />
                                            <dx:ASPxGridView ID="gvSOD" runat="server" ClientInstanceName="gvSOD" AutoGenerateColumns="False" Width="100%" KeyFieldName="Value;Description" Settings-ShowFilterBar="Hidden" Settings-ShowFilterRow="True" OnBeforeColumnSortingGrouping="gvSOD_BeforeColumnSortingGrouping" OnAfterPerformCallback="gvSOD_AfterPerformCallback" OnRowCommand="gvSOD_RowCommand">
                                                <Settings ShowFilterRow="True" ShowFilterRowMenu="true" AutoFilterCondition="Contains"></Settings>
                                                <Columns>
                                                    <dx:GridViewDataColumn Caption="Select" Name="Select" VisibleIndex="0" Width="60px">
                                                        <DataItemTemplate>
                                                            <asp:LinkButton ID="lnkSelectUser" runat="server" Text="Select" OnClientClick="return OnSelectCloseSODpopup();"></asp:LinkButton>
                                                        </DataItemTemplate>
                                                        <CellStyle HorizontalAlign="Left">
                                                        </CellStyle>
                                                    </dx:GridViewDataColumn>
                                            ...
                                            <asp:SqlDataSource runat="server" ID="DSSOD" ConnectionString='<%$ ConnectionStrings:CS %>' ></asp:SqlDataSource>
                                        </dx:PopupControlContentControl>
                                    </ContentCollection>
                                </dx:ASPxPopupControl>--%>
                ...
                <asp:UpdatePanel ID="UpdDeliveryPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                    <ContentTemplate>
                <div class="reg-panel panel panel-default">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <div class="col-sm-4">
                                <fieldset>
                                    ...
                                    <asp:SqlDataSource runat="server" ID="DSSOD" ConnectionString='<%$ ConnectionStrings:CS %>' SelectCommand="SELECT Value, Description FROM SS_ALNDomain WHERE DomainName = 'SOD' and IsActive='1'">
                                    </asp:SqlDataSource>
                                    <div class="form-group" style="margin-left:25px">
                                        <asp:CheckBox ID="chkInternatinal" runat="server" OnCheckedChanged="chkInternatinal_CheckedChanged" AutoPostBack="true" Text="International?" CssClass="clschk" />
                                    </div>
                                    <div class="form-group">
                                        <div class="control-label col-sm-4 Pdringtop">
                                        <asp:Label runat="server" ID="lblincoterms" style="float:left;margin-left:15px">Incoterms</asp:Label>
                                            <asp:Label runat="server" ID="lblSOD" style="float:left;margin-left:-5px">Scope of Delivery</asp:Label>
                                            </div>
                                        <div class="col-sm-7">
                                           <asp:DropDownList ID="ddlIncoterms" Visible="true" runat="server" style="margin-left:-30px" CssClass="form-control" DataValueField="Value" DataTextField="Description" AutoPostBack="true"></asp:DropDownList>
                                        </div>
                                      <div class="col-sm-7">
                                        <asp:TextBox ID="txtSOD" runat="server" CssClass="form-control" style="margin-left:-30px" ValidationGroup="Equip" AutoPostBack="true" OnTextChanged="txtSOD_TextChanged" onkeydown="ShowToolTip(event)"></asp:TextBox>
                                        <asp:HiddenField ID="HidIncotermValues" runat="server" />
                                     </div>
                                         <div style="float: left; margin-left: -12px;" class="col-sm-1">
                                             <%--<img src="../images/search-icon.png" class="SearchImg imgPopup" onclick="return ShowSOD();" />--%>
                                             <asp:ImageButton ID="imgIncoterm" runat="server" style="margin-left:-30px" ImageUrl="~/images/search-icon.png" CssClass="SearchImg imgPopup" Visible="true" OnClick="imgIncoterm_Click" />
                                         </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-4 Pdringtop" style="float:left;margin-left:-20px" for="inputName">
                                            Ship to Address</label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtShiptoAddress" runat="server" CssClass="form-control" style="margin-left:-10px" TextMode="MultiLine" Height="55px" ValidationGroup="Equip" onkeydown="ShowToolTip(event)"></asp:TextBox>
                                        </div>
                                        <div style="width: 2%; float: left;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-4 Pdringtop" style="float:left;margin-left:-20px" for="inputName">
                                            Payment Terms</label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtPaymentTerms" runat="server" CssClass="form-control" style="margin-left:-10px" Height="35" ValidationGroup="Equip" onkeydown="ShowToolTip(event)"></asp:TextBox>
                                        </div>
                                        <div style="width: 2%; float: left;">
                                        </div>
                                    </div>
                        ...
                        <%--INCOTERMS--%>
                                 <dx:ASPxPopupControl ID="popupIncoterms" runat="server" CloseAction="CloseButton" CloseOnEscape="true" Modal="True" ClientInstanceName="popupIncoterms"
                                    PopupHorizontalAlign="WindowCenter" AllowDragging="true" PopupVerticalAlign="WindowCenter" HeaderText="List of Incoterms" Width="450px" PopupAnimationType="None" EnableViewState="False">
                                    <ContentCollection>
                                        <dx:PopupControlContentControl runat="server">
                                            <p>Select Incoterms</p>
                                            <br />
                                            <dx:ASPxGridView ID="gvIncoterms" runat="server" ClientInstanceName="gvIncoterms" AutoGenerateColumns="False" Width="100%" KeyFieldName="Value;Description" OnBeforeColumnSortingGrouping="gvIncoterms_BeforeColumnSortingGrouping" OnAfterPerformCallback="gvIncoterms_AfterPerformCallback" OnRowCommand="gvIncoterms_RowCommand"  Settings-ShowFilterBar="Hidden" Settings-ShowFilterRow="True">
                                                <Settings ShowFilterRow="True" ShowFilterRowMenu="true" AutoFilterCondition="Contains"></Settings>
                                                <SettingsPager PageSize="3"></SettingsPager>
                                                <Columns>
                                                    <dx:GridViewDataColumn Caption="Select" Name="Select" VisibleIndex="0" Width="60px">
                                                        <DataItemTemplate>
                                                            <asp:LinkButton ID="lnkSelectUser" runat="server" Text="Select" OnClientClick="return OnSelectCloseIncotermsPopup();"></asp:LinkButton>
                                                        </DataItemTemplate>
                                                        <CellStyle HorizontalAlign="Left">
                                                        </CellStyle>
                                                    </dx:GridViewDataColumn>
                                                    ...
                                                    <dx:GridViewDataTextColumn FieldName="DomainDesc" VisibleIndex="2">
                                                        <SettingsHeaderFilter>
                                                            <DateRangePickerSettings EditFormatString=""></DateRangePickerSettings>
                                                        </SettingsHeaderFilter>
                                                    </dx:GridViewDataTextColumn>
                                            ...
                                            <asp:SqlDataSource runat="server" ID="DSIncoterms" ConnectionString='<%$ ConnectionStrings:CS %>' SelectCommand="select Value,Description,DomainDesc from SS_ALNDomain where DomainName='INCOTERM' and IsActive=1"></asp:SqlDataSource>
                                        </dx:PopupControlContentControl>
                                    </ContentCollection>
                                </dx:ASPxPopupControl>
                                    ...
                                    <asp:GridView ID="gvShowSeletSupplierAttachment" runat="server" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No search results" AutoGenerateColumns="false" OnRowDataBound="gvShowSeletSupplierAttachment_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Title">
                                                <ItemTemplate>
                                                    <a href="FileDownload.ashx?RowIndex=<%# Container.DisplayIndex %>&fileURL=<%#Eval("FileURL") %>" target="_blank"><%#Eval("Title")%> </a>
                                                </ItemTemplate>
                                            </asp:TemplateField>

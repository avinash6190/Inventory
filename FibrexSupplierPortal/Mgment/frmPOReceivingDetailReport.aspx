<%@ Page Language="C#" MasterPageFile="~/Mgment/mainMaster.Master" AutoEventWireup="true" CodeBehind="frmPOReceivingDetailReport.aspx.cs" Inherits="FibrexSupplierPortal.Mgment.frmPOReceivingDetailReport" %>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-lg-12">
                                  <div class="col-lg-6">
                                      <div class="form-group">
                                        <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                            Division</label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtOrganization" OnTextChanged="txtOrganization_TextChanged" runat="server"  CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style="float: left; margin-left: -12px;" class="col-sm-1">
                                            <img id="imgPOLProject" src="../images/search-icon.png" class="SearchImg imgPopup" onclick="return ClickProjectEvent();" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3 Pdringtop" for="inputName">
                                            Buyer</label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtBuyers" OnTextChanged="txtBuyers_TextChanged" AutoPostBack="true" runat="server" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="col-sm-5 col-sm-offset-5" style="text-align: right;">
                                    &nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btnSearchPOReceive" runat="server" CssClass="btn btn-primary" Text="Run Report" OnClick="btnSearchPOReceive_Click" />

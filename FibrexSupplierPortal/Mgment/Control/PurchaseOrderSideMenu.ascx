...
<ul class="nav" id="side-menu">
    ...
    <li id="SideMenuSearchPOLine" runat="server">
        <a href="frmSearchPOLine"><i class="fa fa-edit fa-fw"></i>Search Purchase Order Line</a>
    </li>
    <li id="SideMenuReports" runat="server">
        <a href="frmEmptyReport"><i class="fa fa-edit fa-fw"></i>Reports</a>
    </li>
    <%--<li id="SideMenuReports" visible="true" runat="server">

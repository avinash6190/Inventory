...
namespace FibrexSupplierPortal.Mgment
{
    public partial class frmSearchPOList : System.Web.UI.Page
    {
        ...
        {
            LoadSearchRecords();
            gvSearchPurchaseOrder.DataColumns["MRNUM"].Visible = true;
            gvSearchPurchaseOrder.DataColumns["PAYMENTTERMS"].Visible = true;
            gvSearchPurchaseOrder.DataColumns["ORDERDATE"].Visible = true;

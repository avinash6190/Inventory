                            ...
                            <div class="col-sm-4">
                                <fieldset>
                                    ...
                                    <div class="form-group" style="margin-left:25px">
                                        <asp:CheckBox ID="chkInternatinal" runat="server" Text="International?" OnCheckedChanged="chkInternatinal_CheckedChanged" AutoPostBack="true" CssClass="clschk" />
                                    </div>
                                    <div class="form-group">
                                        <%--<label  id="lblincoterms" for="inputName">
                                         Incoterms</label>--%>
                                        ...
                                        <div class="col-sm-7">
                                        <asp:TextBox ID="txtIncoterms" Visible="false" runat="server" style="margin-left:-30px" CssClass="form-control" ValidationGroup="Equip" AutoPostBack="true" OnTextChanged="txtIncoterms_TextChanged" onkeydown="ShowToolTip(event)"></asp:TextBox>
                                        <asp:HiddenField ID="HidIncotermValues" runat="server" />
                                     </div>
                                         <div style="float: left; margin-left: -12px;" class="col-sm-1">
                                             <%--<img src="../images/search-icon.png" id="imgIncoterm" class="SearchImg imgPopup" onclick="return ShowSOD();" />--%>
